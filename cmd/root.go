...
var rootCmd = &cobra.Command{
	Use:   "lthmonitor",
	Short: "LTH Monitor is a beautiful web UI to manage pc remotely",
	Long: `LTH Monitor is a beautiful web UI to manage pc remotely.
Source code is available at https://github.com/wintltr.
Complete documentation is available at https://github.com/wintltr.`,

...
func AddUfwRule(w http.ResponseWriter, r *http.Request) {
	...
	err = models.RunAnsiblePlaybookWithVars(vars, "yamls/add_firewall_rule.yml")
	if err != nil {
		utils.ERROR(w, http.StatusBadRequest, errors.New("ansible_playbook for adding ufw rule is missing").Error())
		return
	}
